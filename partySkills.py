...
yukSkills = [skillID.Dia, skillID.Patra, skillID.Garu, skillID.Charmdi, skillID.Magaru, skillID.Media, skillID.Diarama,
             skillID.Recarm, skillID.Garula, skillID.Me_Patra, skillID.Mediarama, skillID.Magarula, skillID.Diarahan,
             skillID.Amrita, skillID.Garudyne, skillID.Wind_Break, skillID.Magarudyne, skillID.Samarecarm,
             skillID.Mediarahan, skillID.Panta_Rhei]

junSkills = [skillID.Spring_of_Life, skillID.Cleave, skillID.Agi, skillID.Re_Patra, skillID.Rakukaja,
...
akiSkills = [skillID.Sonic_Punch, skillID.Zio, skillID.Dia, skillID.Tarunda, skillID.Mazio, skillID.Rakunda,
             ...
             skillID.Matarunda, skillID.Fist_Master, skillID.Ziodyne, skillID.Marakunda, skillID.Diarahan,
             skillID.Masukunda, skillID.Debilitate, skillID.Maziodyne, skillID.Elec_Amp, skillID.Thunder_Reign]

mitSkills = [skillID.Bufu, skillID.Mabufu, skillID.Dia, skillID.Marin_Karin, skillID.Bufula, skillID.Diarama,
             skillID.Spirit_Drain, skillID.Tentarafoo, skillID.Mabufula, skillID.Ice_Boost, skillID.Mind_Charge,
             skillID.Bufudyne, skillID.Diarahan, skillID.Ice_Break, skillID.Mabufudyne, skillID.Ice_Amp,
             skillID.Niflheim]
...
kenSkills = [skillID.Hama, skillID.Cruel_Attack, skillID.Zionga, skillID.Sukunda, skillID.Diarama, skillID.Hamaon,
             ...
             skillID.Vile_Assault, skillID.Diarahan, skillID.Spear_Master, skillID.Primal_Force, skillID.Samarecarm,
             skillID.Sanctify, skillID.Mediarahan, skillID.Thunder_Reign]

shinSkills = [skillID.Regenerate1, skillID.Counter, skillID.Fatal_End, skillID.Evil_Smile, skillID.Counterstrike,
