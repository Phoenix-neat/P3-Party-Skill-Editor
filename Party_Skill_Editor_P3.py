...
if yukariLvl != 0:
    ...
    pnach.write(
        "//Yukari skills \n//Yukari Persona Skill 1\npatch=1,EE,108340F8,extended,00000" + partySkills.yukSkills[0])
    if len(partySkills.yukSkills) > 1:
        pnach.write("\n//Yukari Persona Skill 2\npatch=1,EE,108340FA,extended,00000" + partySkills.yukSkills[1])
    if len(partySkills.yukSkills) > 2:
        pnach.write("\n//Yukari Persona Skill 3\npatch=1,EE,108340FC,extended,00000" + partySkills.yukSkills[2])
    if len(partySkills.yukSkills) > 3:
        pnach.write("\n//Yukari Persona Skill 4\npatch=1,EE,108340FE,extended,00000" + partySkills.yukSkills[3])
    if len(partySkills.yukSkills) > 4:
        pnach.write("\n//Yukari Persona Skill 5\npatch=1,EE,10834100,extended,00000" + partySkills.yukSkills[4])
    if len(partySkills.yukSkills) > 5:
        pnach.write("\n//Yukari Persona Skill 6\npatch=1,EE,10834102,extended,00000" + partySkills.yukSkills[5])
    if len(partySkills.yukSkills) > 6:
        pnach.write("\n//Yukari Persona Skill 7\npatch=1,EE,10834104,extended,00000" + partySkills.yukSkills[6])
    if len(partySkills.yukSkills) > 7:
        pnach.write("\n//Yukari Persona Skill 8\npatch=1,EE,10834106,extended,00000" + partySkills.yukSkills[7])

#for Junpei (vanilla Journey)
